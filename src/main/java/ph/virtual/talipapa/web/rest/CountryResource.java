...
import ph.virtual.talipapa.domain.Country;
import ph.virtual.talipapa.service.CountryService;
...
/**
 * REST controller for managing {@link ph.virtual.talipapa.domain.Country}.
 */
@RestController
@RequestMapping("/api")
