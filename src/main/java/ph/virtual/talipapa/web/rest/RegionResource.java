...
import ph.virtual.talipapa.domain.Region;
import ph.virtual.talipapa.service.RegionService;
...
/**
 * REST controller for managing {@link ph.virtual.talipapa.domain.Region}.
 */
@RestController
@RequestMapping("/api")
