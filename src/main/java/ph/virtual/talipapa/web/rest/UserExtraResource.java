...
import ph.virtual.talipapa.domain.UserExtra;
import ph.virtual.talipapa.service.UserExtraService;
...
/**
 * REST controller for managing {@link ph.virtual.talipapa.domain.UserExtra}.
 */
@RestController
@RequestMapping("/api")
