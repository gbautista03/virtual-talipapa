...
@RestController
@RequestMapping("/api/virtual-talipapa-app-kafka")
public class VirtualTalipapaAppKafkaResource {
    private final Logger log = LoggerFactory.getLogger(VirtualTalipapaAppKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public VirtualTalipapaAppKafkaResource(KafkaProperties kafkaProperties) {
