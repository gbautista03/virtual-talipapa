...
public class UserExtraResourceIT {
    ...
    public void createUserExtra() throws Exception {
        ...
        assertThat(testUserExtra.getFullName()).isEqualTo(DEFAULT_FULL_NAME);
        assertThat(testUserExtra.getContactNumber()).isEqualTo(DEFAULT_CONTACT_NUMBER);
    }
    ...
    public void updateUserExtra() throws Exception {
        ...
        UserExtra testUserExtra = userExtraList.get(userExtraList.size() - 1);
        assertThat(testUserExtra.getFullName()).isEqualTo(UPDATED_FULL_NAME);
        assertThat(testUserExtra.getContactNumber()).isEqualTo(UPDATED_CONTACT_NUMBER);
    }
